...
<head>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="public/backend/{{asset('backend')}}/plugins//summernote/summernote-bs4.min.css">
  <!-- jQuery -->
...
<!-- ./wrapper -->
<!-- jQuery UI 1.11.4 -->
<script src="{{asset('backend')}}/dist/js/jquery-3.5.1.min.js"></script>
...
<script src="{{asset('backend')}}/{{asset('backend')}}/dist/js/demo.js"></script>
<script>
  $(function () {
    $("#example1").DataTable({
      "responsive": true,
